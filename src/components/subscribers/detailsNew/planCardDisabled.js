...
export default function PlanCardDisabled({ item, planSlot }) {
  return (
    <div
      className={`${style.planCard} planCard ${style.active} ${style.disabled}`}
    >
      <div className={style.currentlyPlan}>
        <div className={style.icon}>
          <div className={style.lablename}>Already Active</div>
        </div>
      </div>
