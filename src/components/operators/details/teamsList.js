...
import TeamCard from "@/components/operators/details/teamCard";
...
import { getTeamList } from "@/controllers/operators";
import ShowFilterRecordCount from "@/components/common/showFilterRecordCount";

export default function TeamsList({ keyword, status, sort, operator, handleTeamSelect }) {
