...
export function updateAutoRenewRequest(request, authHeader) {
	return new Promise((resolve, reject) => {
		...
		const payload = {
			api_name: "update_auto_renewal_status_change_request",
			login_id: login_id,
			oper_code: oper_code,
		...
		callPostApiNoSession(apiList.apiV4_0.updateAutoRenewStatusChange, payload, null, authHeader)
