...
export function renewalRequests(request, authHeader) {
	return new Promise((resolve, reject) => {
		...
		callGetApiNoSession(apiList.apiV4_0.getRenewalRequests, payload, null, authHeader)
