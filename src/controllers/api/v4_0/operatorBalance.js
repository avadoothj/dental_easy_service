...
export function operatorBalance(request, authHeader) {
	return new Promise((resolve, reject) => {
		...
		callGetApiNoSession(apiList.apiV4_0.getOperatorBalance, payload, null, authHeader)
