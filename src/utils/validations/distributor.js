...
export const addDistributorValidation = {
	oper_name: {
		required: messages.REQUIRED_DISTRIBUTOR_NAME,
		pattern: {
			value: validateTextPattern(),
			message: messages.INVALID_DISTRIBUTOR_NAME,
		},
	},
	isp_code: {
		required: messages.REQUIRED_DISTRIBUTOR_CODE,
		pattern: {
			value: validationAlphaNum(),
			message: messages.INVALID_DISTRIBUTOR_CODE,
		},
	},
	category: {
